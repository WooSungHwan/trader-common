package com.trader.common.indicators.result;

import com.trader.common.candle.Candle;
import lombok.Value;
...
public class BollingerBands {
     ...
     * @return
     */
    public boolean isBollingerBandUddTouch(Candle candle) {
     ...
     * @return
     */
    public boolean isBollingerBandLddTouch(Candle candle) {
        if (Objects.isNull(candle)) {
            return false;
        }
